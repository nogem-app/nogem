...
/**
* @author L2Portal
* @title L2PortalONFT721
*/
contract L2PortalONFT721 is ONFT721, ERC721Enumerable {
    ...
    */
    constructor(uint256 _minGasToTransfer,address _lzEndpoint,uint256 _startMintId,uint256 _endMintId,uint256 _mintFee,uint256 _bridgeFee,address _feeCollector,uint256 _referralEarningBips) ONFT721("L2PortalONFT Minis", "ZRSM", _minGasToTransfer, _lzEndpoint) {
    ...
    *
    * @dev emits {L2PortalONFT721-MintFeeChanged}
    */
    ...
    *
    * @dev emits {L2PortalONFT721-BridgeFeeChanged}
    */
    ...
    *
    * @dev emits {L2PortalONFT721-ReferralEarningBipsChanged}
    */
    ...
    *
    * @dev emits {L2PortalONFT721-EarningBipsForReferrerChanged}
    */
    ...
    *
    * @dev emits {L2PortalONFT721-EarningBipsForReferrersChanged}
    */
    ...
    *
    * @dev emits {L2PortalONFT721-FeeCollectorChanged}
    */
    ...
    *
    * @dev emits {L2PortalONFT721-TokenURIChanged}
    */
    ...
    *
    * @dev emits {L2PortalONFT721-TokenURILocked}
    */
    ...
    ************/
    ...
    /**
    * @notice Mint new L2Portal ONFT
    *
    * @dev new token ID must be in range [startMintId - maxMintId]
    * @dev tx value must be equal to mintFee. See {L2PortalONFT721-mintFee}
    * @dev emits {L2PortalONFT721-ONFTMinted}
    */
    ...
    * @param _adapterParams relayer adapter parameters
    *
    * @dev emits {L2PortalONFT721-BridgeFeeEarned}
    */
    ...
    * @dev emits {L2PortalONFT721-FeeEarningsClaimed}
    */
    ...
    *
    * @dev earned amount must be more than zero to claim
    * @dev emits {L2PortalONFT721-ReferrerEarningsClaimed}
    */
    ...
    */
    function _validate(bool _clause, uint8 _errorCode) internal pure {
        if (!_clause) revert L2PortalONFT721_CoreError(_errorCode);
    }
}
